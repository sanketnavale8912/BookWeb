...
public interface SubscriptionService 
{
	...
	String createSubscripton(int userId, String transactionID, String paymetnMethod, String gatewayResponse, SB_Plan plan, String clientReferId, Timestamp todayDate, Timestamp validTill, String active);

	SB_Subscription checkValidSubscription(int id);
